...
public class GameScreen implements Screen {
    ...
    private void initBox() {
        ...
        groundBodyDef.position.set(new Vector2(camera.viewportWidth / 2 / PIXELS_TO_METERS,
                        10 / PIXELS_TO_METERS));
        ...
        wallLeftBodyDef.position.set(new Vector2(10 / PIXELS_TO_METERS, camera.viewportHeight / 2
                        / PIXELS_TO_METERS));
        ...
        wallRightBodyDef.position.set(new Vector2((camera.viewportWidth - 10) / PIXELS_TO_METERS,
                        camera.viewportHeight / 2 / PIXELS_TO_METERS));
        ...
        platformBodyDef.position.set(new Vector2((camera.viewportWidth / 2) / PIXELS_TO_METERS,
                        200 / PIXELS_TO_METERS));
        ...
        wallTopDef.position.set(new Vector2(camera.viewportWidth / 2 / PIXELS_TO_METERS,
                        (camera.viewportHeight - 10) / PIXELS_TO_METERS));
